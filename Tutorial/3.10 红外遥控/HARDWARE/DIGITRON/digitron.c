...
void Digi_Show(uchar a,uchar num1,uchar b,uchar num2,uchar c,uchar num3,uchar d,uchar num4,uchar po)
{
 	DIG1 = !a;
	DIG2 = 1;
	DIG3 = 1;
...
void Digi_Num(uint num)
{
	...
	if((num > 0) || (num < 9999))
	{
		...
		Digi_Show(1,a,1,b,1,c,1,d,0);
	}
	else
		Digi_Show(1,9,1,9,1,9,1,9,0);	
}
